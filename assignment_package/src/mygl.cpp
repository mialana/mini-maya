...
//    m_hedgeDisplay.create();
    ...
    Joint j2 = Joint(this, QString("child"), &j1, glm::vec3(0, 0, 1), glm::quat(0, 0, 1, 0));
...
void MyGL::keyPressEvent(QKeyEvent *e)
{
    ...
    if (mp_selectedHedge != nullptr) {
        switch(e->key())
        {
        case Qt::Key_N : emit sig_setSelectedHedge(mp_selectedHedge->next); return;
        case Qt::Key_M : emit sig_setSelectedHedge(mp_selectedHedge->sym); return;
        case Qt::Key_F : emit sig_setSelectedFace(mp_selectedHedge->m_face); return;
        case Qt::Key_V : emit sig_setSelectedVert(mp_selectedHedge->m_vert); return;
        }
    }
