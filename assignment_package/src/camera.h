...
public:
  ...
  Camera(unsigned int w, unsigned int h, const glm::vec3 &e, const glm::vec3 &r,
  ...
  glm::vec3 eye, // The position of the camera in world space
      ...
      look, // The normalized vector from eye to ref. Is also known as the
            // camera's "forward" vector.
      up, // The normalized vector pointing upwards IN CAMERA SPACE. This vector
          // is perpendicular to LOOK and RIGHT.
      right, // The normalized vector pointing rightwards IN CAMERA SPACE. It is
